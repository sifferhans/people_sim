defmodule PeopleSimWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PeopleSimWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PeopleSimWeb.Gettext, "errors", msg, opts)
    end
  end
